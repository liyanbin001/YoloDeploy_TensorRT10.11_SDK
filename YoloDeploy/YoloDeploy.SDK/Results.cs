...
public sealed record SegResult
{
    public required int ClassId { get; init; }
    public required string ClassName { get; init; }
    public required float Confidence { get; init; }
...
{
    public required IReadOnlyList<DetectResult> Detections { get; init; }
}

public sealed record ObbDetectionResponse : YoloDetectionResponse
{
...
{
    public required IReadOnlyList<SegResult> Detections { get; init; }
