...
internal static partial class NativeMethods
{
    ...
    // Same native exports, pointer-based managed declarations for industrial-camera
    // buffers that already live in unmanaged memory.
    [DllImport(
        DllName,
        EntryPoint = "YoloDetectBgra",
        CallingConvention = CallingConvention.Cdecl,
        CharSet = CharSet.Unicode)]
    internal static extern int YoloDetectBgraPointer(
        IntPtr handle,
        IntPtr bgra,
        int width,
        int height,
    ...
    [DllImport(
        DllName,
        EntryPoint = "YoloDetectObbBgra",
        CallingConvention = CallingConvention.Cdecl,
        CharSet = CharSet.Unicode)]
    internal static extern int YoloDetectObbBgraPointer(
        IntPtr handle,
        IntPtr bgra,
        int width,
        int height,
    ...
    [DllImport(
        DllName,
        EntryPoint = "YoloDetectSegBgra",
        CallingConvention = CallingConvention.Cdecl,
        CharSet = CharSet.Unicode)]
    internal static extern int YoloDetectSegBgraPointer(
        IntPtr handle,
        IntPtr bgra,
        int width,
        int height,
